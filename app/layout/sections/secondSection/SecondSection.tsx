            ...
            <Container>
                ...
                <S.Card>
                    ...
                    <ul>
                        ...
                        <li><S.Highlighted color={theme.colors.colorTextNegative}>Не успеваешь
                            реагировать</S.Highlighted> в
                ...
                <S.Card>
                    ...
                    <ul>
                        <li>Продвинутая коммуникация<S.Highlighted color={theme.colors.colorTextAccent}>в
                            профессиональной
                            среде</S.Highlighted></li>
                        <li>Фразы, которые <S.Highlighted color={theme.colors.colorTextAccent}>носители языка используют
                            в
